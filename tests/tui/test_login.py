...
async def _login_cmd(app, pilot):
    app.query_one("#prompt", Composer).value = "/login"
...
async def test_help_opens_overlay_and_unknown_command(make_app, helpers):
    from tribe.tui.screens import HelpScreen
